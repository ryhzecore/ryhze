          ...
          body: SafeArea(
            child: LayoutBuilder(
              builder: (_, c) {
                ...
                final gutter = detailGutter(mobile);
                return Stack(
                  children: [
                    Positioned.fill(
    ...
    return Column(
      ...
      children: [
        if (title.upcoming) ...[
          ...
          else if (title.download != null && !downloading)
            Pill(
          ...
          if (downloading)
            Padding(
              ...
              child: StatusProgress(label: 'Downloading', value: progress),
            ),
          const SizedBox(height: 12),
          const Text(
