class RyhzeTitle {
  ...
  final int revision;
  final bool internal;
  final String hero, storeUrl;
  final List<Map<String, dynamic>> screenshots, packages;
  const RyhzeTitle({
    required this.id,
    required this.title,
    required this.kind,
  ...
  factory RyhzeTitle.fromJson(Map<String, dynamic> j) => RyhzeTitle(
    ...
    screenshots: List<Map<String, dynamic>>.from(j['screenshots'] ?? []),
...
class Member {
  ...
  final bool portalAccess, developerAccess, engineDownloadAccess;
  const Member(
    this.username,
    this.role, {
    this.portalAccess = false,
    this.developerAccess = false,
    this.engineDownloadAccess = false,
  });
  ...
  factory Member.fromJson(Map<String, dynamic> j) => Member(
    j['username'],
    j['role'],
    portalAccess: j['portalAccess'] == true,
    developerAccess: j['developerAccess'] == true,
    engineDownloadAccess:
        j['role'] == 'admin' || j['engineDownloadAccess'] == true,
  );
}
