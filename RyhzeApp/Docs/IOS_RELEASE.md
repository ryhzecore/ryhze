...
The earlier [Liquid Glass capture](https://codemagic.io/app/6aa168715f5464a1c485054c/build/6ab339cea56dee762d5d9344) passed and its iPhone 17 Pro simulator image is in [Google Drive](https://docs.google.com/document/d/17OvnsHBGy17-HmG7loyA98pkR4x34ZSfHiNvxc7AeRE/edit?tab=t.0). Simulator tests cannot establish whether a physical iOS 27 beta device shares the Safari session or whether all glass interactions work there. Those checks require the installed TestFlight build.
