...
Current application version: **1.1.2 (build 10)**. See `RELEASE_NOTES.md` for changes, `GAME_LIBRARY.md` for the Windows game library, and `updates/README.md` for publishing future in-app updates.
